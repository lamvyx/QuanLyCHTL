...
public class KhuyenMaiDAO {
    public boolean themKhuyenMai(KhuyenMai km) {
        ...
        try (Connection conn = ConnectDB.getConnection();
            ...
            ps.setDate(5, km.getNgayBD() != null ? Date.valueOf(km.getNgayBD()) : null);
            ps.setDate(6, km.getNgayKT() != null ? Date.valueOf(km.getNgayKT()) : null);
    ...
    public boolean capNhatKhuyenMai(KhuyenMai km) {
        ...
        try (Connection conn = ConnectDB.getConnection();
            ...
            ps.setDate(4, km.getNgayBD() != null ? Date.valueOf(km.getNgayBD()) : null);
            ps.setDate(5, km.getNgayKT() != null ? Date.valueOf(km.getNgayKT()) : null);
